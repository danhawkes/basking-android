...
public class HoloCircularProgressBar extends View {
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs) {
		this(context, attrs, R.attr.hcpb_style);
	}
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.hcpb_HoloCircularProgressBar,
				defStyle, 0);

		setProgressColor(attributes.getColor(R.styleable.hcpb_HoloCircularProgressBar_hcpb_progress_color, Color.CYAN));
		setProgressBackgroundColor(attributes.getColor(R.styleable.hcpb_HoloCircularProgressBar_hcpb_progress_background_color,
				Color.MAGENTA));
		setProgress(attributes.getFloat(R.styleable.hcpb_HoloCircularProgressBar_hcpb_progress, 0.0f));
		setMarkerProgress(attributes.getFloat(R.styleable.hcpb_HoloCircularProgressBar_hcpb_marker_progress, 0.0f));
		setWheelSize((int) attributes.getDimension(R.styleable.hcpb_HoloCircularProgressBar_hcpb_stroke_width, 10));
		mIsThumbEnabled = attributes.getBoolean(R.styleable.hcpb_HoloCircularProgressBar_hcpb_thumb_visible, true);
		mIsMarkerEnabled = attributes.getBoolean(R.styleable.hcpb_HoloCircularProgressBar_hcpb_marker_visible, true);
		mGravity = attributes.getInt(R.styleable.hcpb_HoloCircularProgressBar_android_gravity, Gravity.CENTER);
