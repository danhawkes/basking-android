...
public class LoginPreference extends DialogPreference {
	...
	private void showUsernameError() {
		usernameField.setError(getContext().getResources().getString(
				R.string.pref_error_username_required));
	}

	private void showPasswordError() {
		passwordField.setError(getContext().getResources().getString(
				R.string.pref_error_password_required));
	}
	...
	private ListenableFuture<Void> validateCredentials(String username, String password) {
		...
		return executor.submit(new Callable<Void>() {
			...
			public Void call() throws Exception {
				new Client().login(usernameField.getText().toString(), passwordField.getText()
						.toString());
				return null;
			}
		});
